...
const DashboardPage = () => {
  ...
  return (
    <div className="dashboard-container" style={{ backgroundColor: '#f8fafc', color: '#475569', minHeight: '100vh', display: 'flex' }}>
      
      {/* Sidebar navigation */}
      <aside className="new-sidebar" style={{ width: '280px', backgroundColor: '#020617', display: 'flex', flexDirection: 'column', height: '100vh', position: 'fixed', zIndex: 100 }}>
        <div className="logo-area" style={{ padding: '1.5rem', borderBottom: '1px solid #1e293b' }}>
          <div className="d-flex align-items-center gap-2">
            <i className="fa-solid fa-cubes text-info fs-3"></i>
            <div className="logo-text text-white fw-bold d-flex flex-column" style={{ fontSize: '1.2rem', lineHeight: '1.2' }}>
              Zero Inventory
              <span className="text-secondary" style={{ fontSize: '0.65rem', letterSpacing: '0.5px' }}>MANAGEMENT SYSTEM</span>
            </div>
          </div>
        </div>
        ...
        <ul className="sidebar-nav-list" style={{ listStyle: 'none', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', flexGrow: 1, margin: 0 }}>
          <li className="sidebar-nav-item active" style={{ display: 'block' }}>
            <a href="#dashboard" onClick={() => playSynthSound('click')} className="text-white d-flex align-items-center gap-3 p-2 rounded text-decoration-none" style={{ backgroundColor: 'rgba(14, 165, 233, 0.15)', borderLeft: '3px solid #0ea5e9', borderTopLeftRadius: 0, borderBottomLeftRadius: 0 }}>
              <i className="fa-solid fa-house text-info"></i> Dashboard
            </a>
          </li>
          <li className="sidebar-nav-item">
            <a href="#billing" onClick={() => playSynthSound('click')} className="text-secondary d-flex align-items-center gap-3 p-2 rounded text-decoration-none hover-light-bg">
              <i className="fa-solid fa-file-invoice"></i> Generate Bill
            </a>
          </li>
          <li className="sidebar-nav-item">
            <a href="#products" onClick={() => playSynthSound('click')} className="text-secondary d-flex align-items-center gap-3 p-2 rounded text-decoration-none hover-light-bg">
              <i className="fa-solid fa-box-open"></i> Products
            </a>
          </li>
          <li className="sidebar-nav-item">
            <a href="#sales" onClick={() => playSynthSound('click')} className="text-secondary d-flex align-items-center gap-3 p-2 rounded text-decoration-none hover-light-bg">
              <i className="fa-solid fa-chart-line"></i> Sales
            </a>
          </li>
          <li className="sidebar-nav-item">
            <a href="#purchases" onClick={() => playSynthSound('click')} className="text-secondary d-flex align-items-center gap-3 p-2 rounded text-decoration-none hover-light-bg">
              <i className="fa-solid fa-cart-shopping"></i> Purchases
            </a>
          </li>
          <li className="sidebar-nav-item">
            <a href="#inventory" onClick={() => playSynthSound('click')} className="text-secondary d-flex align-items-center gap-3 p-2 rounded text-decoration-none hover-light-bg">
              <i className="fa-solid fa-warehouse"></i> Inventory
            </a>
          </li>
          <li className="sidebar-nav-item">
            <a href="#categories" onClick={() => playSynthSound('click')} className="text-secondary d-flex align-items-center gap-3 p-2 rounded text-decoration-none hover-light-bg">
        ...
        <div className="sidebar-bottom-user p-3 border-top border-secondary border-opacity-15 d-flex align-items-center justify-content-between text-white">
          <div className="d-flex align-items-center gap-2">
            <div className="avatar-circle rounded-circle bg-info text-dark d-flex align-items-center justify-content-center fw-bold" style={{ width: '36px', height: '36px', fontSize: '0.95rem' }}>
              {userInitial()}
            </div>
            <div style={{ maxWidth: '140px', overflow: 'hidden' }}>
              <div className="fw-bold small" style={{ fontSize: '0.78rem' }}>Merchant Account</div>
              <div className="text-secondary small text-truncate" style={{ fontSize: '0.68rem' }}>{user?.email || 'merchant@gmail.com'}</div>
            </div>
          </div>
        ...
        <header className="new-header" style={{ backgroundColor: '#ffffff', borderBottom: '1px solid #e2e8f0', height: '70px', padding: '0 2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', sticky: 'top', zIndex: 90 }}>
          <div className="d-flex align-items-center gap-3">
            ...
            <div className="header-search-box d-none d-lg-flex align-items-center px-3 py-1 rounded-pill" style={{ backgroundColor: '#f1f5f9', border: '1px solid #e2e8f0', width: '320px' }}>
              ...
              <input type="text" className="bg-transparent border-0 outline-none" style={{ fontSize: '0.85rem', width: '100%' }} placeholder="Search for products, customers, invoices..." />
            </div>
          </div>

          <div className="header-right-tools d-flex align-items-center gap-3">
            {/* SaaS Access Code Widget */}
            <div className="header-saas-box d-flex align-items-center gap-2 px-3 py-1.5 rounded-3 border border-dashed border-info" style={{ backgroundColor: '#f0f9ff' }}>
              <span className="header-saas-label text-secondary small fw-semibold"><i className="fa-solid fa-key me-1 text-info"></i>SaaS Code:</span>
              <span className="header-saas-value font-monospace text-info fw-bold small">{formattedSaasCode()}</span>
              <button className="btn p-0 border-0" onClick={() => { playSynthSound('click'); setShowSaasCode(!showSaasCode); }} title="Toggle SaaS Code Visibility">
                <i className={`fa-regular ${showSaasCode ? 'fa-eye-slash' : 'fa-eye'} text-secondary`}></i>
              </button>
            </div>

            <button className="btn p-1 text-secondary" onClick={() => playSynthSound('click')}><i className="fa-solid fa-gear fs-5"></i></button>
            <div className="position-relative">
              <button className="btn p-1 text-secondary" onClick={() => playSynthSound('click')}>
                <i className="fa-regular fa-bell fs-5"></i>
                <span className="position-absolute top-1 start-7 translate-middle p-1 bg-danger border border-light rounded-circle"></span>
              </button>
            </div>
            
            <div className="user-avatar-circle rounded-circle d-flex align-items-center justify-content-center fw-semibold text-info" style={{ width: '32px', height: '32px', fontSize: '0.85rem', backgroundColor: '#e0f2fe' }}>
              {userInitial()}
            </div>
          </div>
        </header>
        ...
        <div className="content-area p-4" style={{ flexGrow: 1 }}>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div>
              ...
              <p className="text-secondary small mb-0">Welcome back, Merchant! Here's what's happening with your store today.</p>
            </div>
            <div className="d-flex align-items-center gap-2">
              <div className="px-3 py-2 bg-white border border-light rounded-3 shadow-sm text-secondary small fw-medium">
                <i className="fa-regular fa-calendar me-2"></i>Jun 20, 2026 - Jun 20, 2026
              </div>
              <button className="btn btn-info text-dark fw-semibold d-flex align-items-center gap-2 shadow-sm" onClick={() => triggerAlert('Audit Logs', 'Opening audit logs database records...')}>
          ...
          <div className="row g-4 mb-4">
            <div className="col-sm-6 col-xl-3">
              <div className="metric-card bg-white p-4 rounded-4 shadow-sm border border-light d-flex justify-content-between align-items-center">
                <div className="metric-info">
                  <h3 className="text-secondary text-uppercase fw-semibold mb-1" style={{ fontSize: '0.78rem', letterSpacing: '0.5px' }}>Total Products</h3>
                  <div className="metric-number text-dark fw-extrabold fs-3">{stats.totalProducts}</div>
                </div>
                <div className="metric-icon-box rounded-3 d-flex align-items-center justify-content-center bg-info bg-opacity-10 text-info" style={{ width: '48px', height: '48px', fontSize: '1.4rem' }}>
            ...
            <div className="col-sm-6 col-xl-3">
              <div className="metric-card bg-white p-4 rounded-4 shadow-sm border border-light d-flex justify-content-between align-items-center">
                <div className="metric-info">
                  <h3 className="text-secondary text-uppercase fw-semibold mb-1" style={{ fontSize: '0.78rem', letterSpacing: '0.5px' }}>Total Stock Value</h3>
                  <div className="metric-number text-dark fw-extrabold fs-3">${stats.totalStockValue.toFixed(2)}</div>
                </div>
                <div className="metric-icon-box rounded-3 d-flex align-items-center justify-content-center bg-success bg-opacity-10 text-success" style={{ width: '48px', height: '48px', fontSize: '1.4rem' }}>
            ...
            <div className="col-sm-6 col-xl-3">
              <div className="metric-card bg-white p-4 rounded-4 shadow-sm border border-light d-flex justify-content-between align-items-center">
                <div className="metric-info">
                  <h3 className="text-secondary text-uppercase fw-semibold mb-1" style={{ fontSize: '0.78rem', letterSpacing: '0.5px' }}>Total Item Units</h3>
                  <div className="metric-number text-dark fw-extrabold fs-3">{stats.totalItemUnits}</div>
                </div>
                <div className="metric-icon-box rounded-3 d-flex align-items-center justify-content-center bg-primary bg-opacity-10 text-primary" style={{ width: '48px', height: '48px', fontSize: '1.4rem' }}>
            ...
            <div className="col-sm-6 col-xl-3">
              <div className="metric-card bg-white p-4 rounded-4 shadow-sm border border-light d-flex justify-content-between align-items-center">
                <div className="metric-info">
                  <h3 className="text-secondary text-uppercase fw-semibold mb-1" style={{ fontSize: '0.78rem', letterSpacing: '0.5px' }}>Low Stock Warns</h3>
                  <div className="metric-number text-danger fw-extrabold fs-3">{stats.lowStockWarns}</div>
                </div>
                <div className="metric-icon-box rounded-3 d-flex align-items-center justify-content-center bg-danger bg-opacity-10 text-danger" style={{ width: '48px', height: '48px', fontSize: '1.4rem' }}>
              ...
              <div className="bg-white p-4 rounded-4 shadow-sm border border-light h-100">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div>
                    ...
                    <p className="text-secondary small mb-0">Real-time asset valuation across your active segments</p>
                  </div>
                  <button className="btn btn-link text-info text-decoration-none small p-0 fw-semibold" onClick={() => triggerAlert('Categories', 'Manage category catalog details...')}>Manage Categories</button>
                </div>
                      ...
                      {categoryValuation.length === 0 ? (
                        ...
                        categoryValuation.map((cat, idx) => (
                          <tr key={idx}>
                            ...
                            <td className="fw-semibold text-info">${cat.assetValuation.toFixed(2)}</td>
                          </tr>
                        ))
                      )}
                    </tbody>
              ...
              <div className="bg-white p-4 rounded-4 shadow-sm border border-light h-100">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div>
                    ...
                    <p className="text-secondary small mb-0">Historical monthly sales run-rate</p>
                  </div>
                  <button className="btn btn-link text-info text-decoration-none small p-0 fw-semibold" onClick={() => triggerAlert('Invoices', 'Viewing historical invoices records...')}>View Invoices</button>
                </div>
                      ...
                      {monthlyRevenue.length === 0 ? (
                        ...
                        monthlyRevenue.map((item, idx) => (
                          <tr key={idx}>
                            ...
                            <td>{item.invoices}</td>
                            <td className="fw-semibold text-success">${item.revenue.toFixed(2)}</td>
                          </tr>
                        ))
                      )}
                    </tbody>
            ...
            <div className="col-lg-4">
              <div className="bg-white p-4 rounded-4 shadow-sm border border-light h-100">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <button className="btn btn-link text-info text-decoration-none small p-0 fw-semibold" onClick={() => triggerAlert('Alerts', 'Viewing all stock level warnings...')}>View All</button>
                </div>
                ...
                {lowStockAlerts.length === 0 ? (
                  ...
                  <div className="d-flex flex-column gap-3">
                    {lowStockAlerts.map(alertItem => (
                      <div key={alertItem._id} className="p-3 bg-light rounded-3 border border-light d-flex justify-content-between align-items-center">
                        <div>
                          <div className="fw-bold text-dark small">{alertItem.name}</div>
                          <div className="text-secondary font-monospace" style={{ fontSize: '0.7rem' }}>SKU: {alertItem.sku}</div>
                        </div>
                        <div className="text-end">
                          <span className="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-20 px-2 py-1 small">
              ...
              <div className="bg-white p-4 rounded-4 shadow-sm border border-light h-100">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <div className="d-flex gap-2">
                    <button 
                      className={`btn btn-sm ${recentActivityTab === 'sales' ? 'btn-info text-dark fw-bold' : 'btn-light text-secondary'}`}
                      onClick={() => { playSynthSound('click'); setRecentActivityTab('sales'); }}
                    >
                      Sales
                    </button>
                    <button 
                      className={`btn btn-sm ${recentActivityTab === 'purchases' ? 'btn-info text-dark fw-bold' : 'btn-light text-secondary'}`}
                  ...
                  recentSales.length === 0 ? (
                    ...
                    <div className="d-flex flex-column gap-2">
                      {recentSales.map(sale => (
                        <div key={sale._id} className="d-flex justify-content-between align-items-center py-2 border-bottom border-light">
                          <div>
                            <div className="fw-bold text-dark small">{sale.invoice_number}</div>
                            <div className="text-secondary small" style={{ fontSize: '0.75rem' }}>{sale.customer_name}</div>
                          </div>
                          <div className="text-end">
                            <div className="fw-semibold text-success small">${sale.grand_total.toFixed(2)}</div>
                            <div className="text-secondary" style={{ fontSize: '0.68rem' }}>{new Date(sale.sale_date).toLocaleDateString()}</div>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  recentPurchases.length === 0 ? (
                    ...
                    <div className="d-flex flex-column gap-2">
                      {recentPurchases.map(purchase => (
                        <div key={purchase._id} className="d-flex justify-content-between align-items-center py-2 border-bottom border-light">
                          <div>
                            <div className="fw-bold text-dark small">{purchase.purchase_number}</div>
                            <div className="text-secondary small" style={{ fontSize: '0.75rem' }}>{purchase.supplier_name}</div>
                          </div>
                          <div className="text-end">
                            <div className="fw-semibold text-primary small">${purchase.grand_total.toFixed(2)}</div>
                            <div className="text-secondary" style={{ fontSize: '0.68rem' }}>{new Date(purchase.purchase_date).toLocaleDateString()}</div>
                          </div>
                        </div>
                      ))}
                    </div>
              ...
              <div className="bg-white p-4 rounded-4 shadow-sm border border-light h-100">
                ...
                <div className="quick-action-grid">
                  <button className="quick-action-item border-0" onClick={() => triggerAlert('Navigation', 'Redirecting to add new product catalog page...')}>
                    <i className="fa-solid fa-square-plus text-primary"></i>
                    Add Product
                  </button>
          ...
          <div className="row">
            <div className="col-12">
              <div className="p-4 rounded-4 shadow-sm text-white" style={{ backgroundColor: '#111827', border: '1px solid #1e293b' }}>
                <h3 className="fs-5 fw-bold mb-1"><i className="fa-solid fa-star text-warning me-2"></i>Post Shop Feedback</h3>
                <p className="text-secondary small mb-4">Share your review about Zero Inventory Management. Your review will publish directly to the landing page "Purchased Shops" feedback list.</p>
                
                <form onSubmit={handleFeedbackSubmit}>
                  <div className="row g-3 mb-3">
                    <div className="col-md-6">
                      <div className="form-group mb-0">
                        <label className="form-label text-secondary small mb-1">Your Shop Name</label>
                        <input 
                          type="text" 
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-0">
                        <label className="form-label text-secondary small mb-1">Rating (1 to 5 Stars)</label>
                        <select 
                          className="form-control-premium" 
                          style={{ backgroundColor: '#1e293b', borderColor: '#334155', color: '#ffffff' }}
                          value={rating}
                  ...
                  <div className="form-group mb-4">
                    <label className="form-label text-secondary small mb-1">Comment / Review</label>
                    <textarea 
                      className="form-control-premium" 
                      style={{ backgroundColor: '#1e293b', borderColor: '#334155', color: '#ffffff', minHeight: '80px' }}
